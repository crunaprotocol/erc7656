...
This is a reference implementation for the [ERC-7656](https://eips.ethereum.org/EIPS/eip-7656) standard.
...
To make your plugin extend `erc7656/ERC7656Service.sol` or `erc7656/extensions/ERC7656ServiceExt`.
